  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.header}>
        <div>
          <h1 className={styles.headerTitle}>{t("project.listTitle")}</h1>
          <p className={styles.headerSub}>{t("project.listSubtitle")}</p>
        </div>
      ...
      <div className={styles.content}>
        ...
        {data && data.projects.length === 0 && (
          <div className={styles.emptyWrap}>
            ...
            <h3 className={styles.emptyTitle}>{t("project.noProjects")}</h3>
